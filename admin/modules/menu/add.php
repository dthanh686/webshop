                            ...
                            <form id="demo-form2" action="" method="POST" class="form-horizontal form-label-left bor"
                                ...
                                <div class="col-md-12 bor" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-2 col-md-offset-2" for="first-name"> Tên Menu
                                            <span class="required">(*)</span>
                                        </label>
                                        <div class="col-md-5">
                                            <input type="text" name="tenmenu" class="form-control col-md-7 col-xs-12"
                                                   value="<?php echo isset($tenmenu) ? $tenmenu : '' ?>">
                                        </div>
                                    </div>
